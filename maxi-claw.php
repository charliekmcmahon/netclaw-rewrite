...
<div class="container-md">
    ...
    <div class="row mb-3">
        <div class="col-sm-8"><!-- Left (large) column -->
            <span class="badge bg-secondary">Claw machine</span> <span class="badge bg-success">Netclaw-owned</span>
            <img class="stream-playing rounded" style='height: 100%; width: 100%; object-fit: contain;' src="https://us.stream.proxy.netclaw.com.au/ramsom/maxi-claw"></img>
        </div>
        <div class="col-lg-4"><!-- Right (small) column -->
            <h4>Controls</h4>
            <hr>
            <iframe class="" src="play.php" style='height: 100%; width: 100%; object-fit: contain'></iframe>
        </div>
    </div>
</div>
